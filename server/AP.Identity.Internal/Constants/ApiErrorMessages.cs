...
public static class ApiErrorMessages
{
    ...
    public static readonly ApiError UserAccessDenied = new("user_access_denied", "Access to user id {0} is denied with check {1}", StatusCodes.Status401Unauthorized);
    ...
    public static readonly ApiError CannotDeleteTenantWithUsers = new("cannot_delete_tenant_with_users", "Cannot delete tenant {0} id {1} referenced by existing users", StatusCodes.Status403Forbidden);
