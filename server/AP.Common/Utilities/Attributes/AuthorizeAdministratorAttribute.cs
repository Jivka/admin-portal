...
public class AuthorizeAdministratorAttribute : AuthorizeAttribute, IAuthorizationFilter
{
    ...
    public void OnAuthorization(AuthorizationFilterContext context)
    {
        ...
        if (contextUser == null || !contextUser.IsSystemAdministrator())
        {
            var apiError = UserNotAdminError.WithMessageArgs(SystemAdministratorRoleDisplayName);
